...
@section('navbar')
                    ...
                    <nav class="navbar navbar-default" role="navigation">
                        ...
                        <div class="collapse navbar-collapse" id="mainMenu">
                            ...
                            <ul class="nav navbar-nav pull-right">
                                ...
                                <li class="sep"></li>
                                <li class="primary">
                                    <a href="{{url('/gallery')}}" class="firstLevel last">Gallery</a>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <div class="footerWidget">
                                ...
                                <h3>The Designer</h3>
                                <p><a href="http://irongecko.co.za" title="Irongecko Productions">Irongecko
                                        Productions</a> is a web design and development studio.
                                    We build responsive websites, integrating best web design
                                    practices and up-to-date web technologies to create great user experiences.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="footerWidget">
                                ...
                                <ul class="list-unstyled iconList borderList">
                                    <li><a href="#">Building with reinforced concrete</a></li>
                                    <li><a href="#">Using tiles with a purpose</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <ul class="socialNetwork">
                                ...
                                <li><a href="#" class="tips" title="follow us on Twitter"><i
                                                class="icon-twitter-bird iconRounded"></i></a></li>
                                <li><a href="#" class="tips" title="follow us on Google+"><i
    ...
    <script type="text/javascript"
            src="js-plugin/revolution-slider/rs-plugin/js/jquery.themepunch.plugins.min.js"></script>
    <script type="text/javascript"
            src="js-plugin/revolution-slider/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
